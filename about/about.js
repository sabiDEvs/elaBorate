(() => {
  ...
  const e = (e, t) => {
      ...
      return (
        (a.textContent = t), o.appendChild(a), (o.href = e), n.appendChild(o), n
      );
    },
    t = (e, t = "elaBorate") => {
      const n = document.createElement("div"),
        o = document.createElement("img");
      (o.src = e), n.appendChild(o);
      const a = document.createElement("h1");
      return (a.textContent = t), n.appendChild(a), n;
    },
    n = (t) => {
      const n = document.createElement("nav"),
        ...
        a = e(t[2], "About"),
        i = e(t[1], "Reports"),
        s = e("mailto:info.sabidevs@gmail.com", "Contact Us");
      return (
        n.appendChild(o),
        n.appendChild(a),
        n.appendChild(i),
    ...
    o = function (e, t) {
      ...
      return e.appendChild(n), (n.textContent = t), n;
    },
    a = function (e, t) {
  ...
  ((e, o) => {
    const a = document.createElement("header"),
      i = t("../asset/images/89c558426b41fccd73cd.png");
    i.id = "iconDiv";
    const s = n(o);
    s.classList.add("nav");
    ...
    d.src = "../asset/images/ecb34bb8fa4ecc3a4316.png";
      ...
      ((e) => {
        ...
        for (let e = 0; e < 3; e++)
          (n[e] = document.createElement("div")),
            n[e].classList.add("bars"),
            t.appendChild(n[e]);
        t.addEventListener("click", () => {
          document.querySelector(".nav").classList.toggle("active"),
            "nav active" === document.querySelector(".nav").className
              ? (alert("active"),
  ...
  y.classList.add("div-img-mission"), m.appendChild(y);
  const v = document.createElement("img");
  y.appendChild(v), (v.src = "../asset/images/ee9f073d24a99867a038.png");
  const w = document.createElement("section");
  w.classList.add("section-help"),
    w.classList.add("container"),
    l.appendChild(w);
  const f = document.createElement("div");
  w.appendChild(f),
    o(f, "Why allow us help you?"),
    a(
      f,
  ...
  E.classList.add("section-achieve"),
    E.classList.add("container"),
    l.appendChild(E);
  const C = document.createElement("div");
  C.classList.add("container-achieve"), E.appendChild(C);
  const b = document.createElement("div");
  b.classList.add("div-img-achieve"), C.appendChild(b);
  const L = document.createElement("img");
  b.appendChild(L), (L.src = "../asset/images/9f85bcb065b488f77419.png");
  const x = document.createElement("div");
  x.classList.add("div-text-achieve"),
    C.appendChild(x),
    o(x, "What we hope to achieve"),
    a(
      x,
  ...
  A.classList.add("section-navigate"),
    A.classList.add("container"),
    l.appendChild(A);
  const S = document.createElement("div");
  S.classList.add("container-navigate"), A.appendChild(S);
  const k = document.createElement("div");
  k.classList.add("div-header-navigate"),
    S.appendChild(k),
    o(k, "Navigating elaBorate"),
    a(
      S,
    ...
    (function (e, t) {
      ...
      e.appendChild(n),
        [
          ...
          t.classList.add("first-list-item"),
            (t.textContent = e[0]),
            n.appendChild(t);
          const o = document.createElement("li");
          return (
            o.classList.add("second-list-item"),
            t.appendChild(o),
            (o.textContent = e[1]),
            o
          );
  ...
  T.classList.add("section-cta"),
    T.classList.add("container"),
    l.appendChild(T);
  const M = document.createElement("div");
  M.classList.add("container-cta"), T.appendChild(M);
  const W = document.createElement("div");
  W.classList.add("container-cta-header"), M.appendChild(W);
  const R = document.createElement("div");
  R.classList.add("container-cta-text"),
    M.appendChild(R),
    o(W, "Let's get Started!"),
    a(
      R,
  ...
  const B = document.createElement("div");
  B.classList.add("container-cover"), M.appendChild(B);
  const q = document.createElement("div");
  q.classList.add("container-cta-btn"), B.appendChild(q);
  const H = document.createElement("a");
  (H.href = "../report/report.html"),
    H.classList.add("btn-view-reports"),
    (H.textContent = "VIEW REPORTS"),
    q.appendChild(H),
    ((e, o) => {
      const a = document.createElement("footer"),
        i = document.createElement("section"),
        s = t("../asset/images/89c7f3e4da4391052d31.png", ""),
        r = n(o);
      (r.id = "footerNav"),
        i.appendChild(s),
        i.appendChild(r),
      ...
      c.textContent = "Get our latest innovative news";
      ...
      (h.type = "email"),
        ...
        (h.id = "subEmail");
      const p = document.createElement("div");
      (p.textContent = "Subscribe"),
        (p.id = "subButton"),
        l.appendChild(h),
        l.appendChild(p);
      const u = document.createElement("div");
      u.innerHTML = `&#169; Copyright <span>${new Date().getFullYear()}</span>`;
      const m = document.createElement("p");
      (m.innerHTML = "All rights reserved. A <span>sabi</span>Devs initiative"),
        d.appendChild(c),
        d.appendChild(l),
        d.appendChild(u),
        d.appendChild(m),
