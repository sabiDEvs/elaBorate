...
const displayWW201 = () => {
  ...
  const objectives = [
    "To know the materials used in woodwork shop",
    "To familiarize with the tools used in woodwork shop",
    "To know how to cut wood",
    "To know how to plane wood",
  ];
  let list = [];
  ...
  text2.textContent =
    "One of the materials used in wood work practice is wood. Wood is a natural material derived from the stems, branches, and roots of trees and there are different classes of wood, the main classes include:";
  ...
  const parts = [
    ...
    },
    {
      ...
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/nuEz8TtrfjM?si=317XhtwxAT8UBvLZ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
      list: "Use rip saw to cut 600mm long",
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/0IsDvh7GR4A?si=iRoHhqI4YNqkoDaw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
      list: "Use the cross cut saw to the required length",
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/UmQdaWy3Pw0?si=o0A7GIikOJTJ1uCd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
      list: "Mark out diagonal line using the sliding bevel",
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/nzQYd8wxCQE?si=8L3MYpv6SQVbkooR" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
      list: "Use tenon saw to cut the diagonal line",
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/au8ejou2VpE?si=ozX0ptTuVx-uyUdk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
  ];
  parts.forEach((item) => {
  ...
  description1.textContent =
    "The link to watch how to perform the butt joint practical is below 👇";
  practicals.appendChild(description1);
  const video3 = document.createElement("div");
  video3.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/jxvOepMFtbA?si=UPxGfMvk_uYu0Mud" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  const parts1 = [
    ...
    },
    {
      ...
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/t3v3J1EFrR8?si=9UKoG3eAqFxBVC4F" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
      list: "Use plane in smoothing the surface",
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/c65rKk8frhc?si=WzZWCbuzb5Grk_A7" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
      list: "Use the cross cut saw to the required length",
      video:
    ...
    },
    {
      ...
      video:
        '<iframe src="https://www.youtube-nocookie.com/embed/JxqqVFL_HN0?si=B0LdOsZpFApRrbr_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>',
    },
    {
  ...
  description2.textContent =
    "The link to watch how to perform the Tee halving Joint practical is below 👇";
  practicals.appendChild(description2);
  const video4 = document.createElement("div");
  video4.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/5xOXRyVJ_1A?si=h5s7a-IHCwNsZdzO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  description3.textContent =
    "The link to watch how to perform the Dovetail halving Joint practical is below 👇";
  practicals.appendChild(description3);
  const video5 = document.createElement("div");
  video5.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/9jgRfef4ZnE?si=QyfCg0XiURVowmfH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  const precautions = [
    "I ensured that I wore my lab coat and personal protective equipment (PPE)",
    "I ensured that proper techniques for cutting, drilling, and sanding to minimize the risk of accidents.",
    "I ensured that I avoided cutting towards yourself and keep your hands and fingers away from blades and moving parts.",
  ];
  let cautionBox = [];
  ...
  concText.textContent =
    "At the end of this experiment, cutting of wood, planning of wood was understood and also a tee halving joint, dovetail halving joint was developed and was also understood.";
  ...
  const reference = [
    "Production Engineering Laboratory Manual for ELA201 and ELA202 by Department of Production Engineering, University of Benin.",
    "Foundations of Woodworking: Essential Joinery Techniques and Building Strategies by Michael Pekovich",
...
for (let i = 0; i < resultsListItems.length; i++) {
  ...
  resBox[i].textContent = reference[i];
  resList.appendChild(refBox[i]);
}
...
const displayBF201 = () => {
  ...
  const objList = document.createElement("ul");
  const objectives = [
    "To know the tools used in the fitting shop",
    "To know how to mark out",
    "To know the methods of filing",
    "To produce a square fit",
  ];
  let list = [];
  for (let i = 0; i < objectives.length; i++) {
    list[i] = document.createElement("li");
  ...
  const explain = document.createElement("div");
  explain.textContent =
    "Bench fitting is the process of shaping and assembling metal components using hand tools and machines.The goal of bench fitting is to create parts that fit together precisely without any gaps or binding. This is achieved by carefully marking out, cutting, filing, and assembling the components.Here are some of the common tasks involved in bench fitting:";
  theory.appendChild(explain);
  const categories = [
    {
      title: "Marking out",
  ...
  const text2 = document.createElement("p");
  text2.textContent =
    "The link to watch how to perform these methods of filing is below 👇";
  theory.appendChild(text2);
  const video2 = document.createElement("div");
  video2.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/IVHh4ACI3ak?si=_4fruPQ4_sz4HFdV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  const step1 = document.createElement("h2");
  step1.textContent =
    "PRACTICAL 1 : HOW TO MAKE A SQUARE FIT FROM GIVEN MILD STEEL PIECES";
  practicals.appendChild(step1);
  const step3 = document.createElement("h3");
  ...
  const steps1 = [
    ...
    "One edge of given is filled to straightness with tough and smooth files and checked with adjacent",
    "An adjacent is also filled such that is square to the first edge and checked with try square",
    "Wet chalk is applied on one side of the flat and dried for marking",
    "Lines are marked according to given figure, using odd leg calliper and steel rule",
    "Using dot punch are made along the marked lines",
    "The excess materials removed from the remaining two edges with the try square level up to half of the marked dots ",
    "Finally buts are removed by the filing on the surface of fitted job",
  ];
  let stepBox1 = [];
  for (let i = 0; i < steps1.length; i++) {
    stepBox1[i] = document.createElement("li");
  ...
  text3.textContent =
    "The link to watch how to perform the square fit practical is below 👇";
  practicals.appendChild(text3);
  const video3 = document.createElement("div");
  video3.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/NHLpRgLGeEo?si=pzWNtzvkNie563nV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video3);
  ...
  const steps = [
    "Place the work pieces on the table and using scriber draw straight lines parallel on it 55mm apart",
    "Fix the workpieces firmly in the jaws of the vice",
    "Cut along the marked line using a hacksaw",
    "The cut out workpieces was now again placed firmly between the jaws of the vice in a such a way that a small portion of one of its edges is above the level of the jaw",
    "Now filing is done by using a hand file",
    "Using try square, it should be ensured that all the edges of the workpieces are at the right angles to adjacent edges",
    "Placed the work on one of the faces on the surface plate and moved it along it’s surface to check the area on the work where strain has accumulated. File them properly ",
  ];
  let stepBox = [];
  ...
  text4.textContent =
    "The link to watch how to perform the Dovetail Joint practical is below 👇";
  practicals.appendChild(text4);
  const video4 = document.createElement("div");
  video4.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/ZB_gn7cZRfo?si=xrhH2-0Iq3mOrspo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video4);
  ...
  const steps4 = [
    "The given mild steel flat piece is checked for given dimensions",
    "One edge of the given is filed with rough and smooth files and checked with try square for straightness",
    "An adjacent edge is also filled such that it is square to first edge and checked with try square",
    "Wet chalk is applied on one side of the flat and dried for marking",
    "Lines are marked according to given figure, using odd leg calipers and steel rule ",
    "Using dot punch, punches are made along the marked lines",
    "The excess materials removed from the remaining two edges with try square level up to half of the marked dots",
    "Finally buts are removed by the filing on the surface of the  fitted job",
  ];
  let stepBox2 = [];
  for (let i = 0; i < steps4.length; i++) {
    stepBox2[i] = document.createElement("li");
  ...
  text5.textContent =
    "The link to watch how to perform the V-fitting practical is below 👇";
  practicals.appendChild(text5);
  const video5 = document.createElement("div");
  video5.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/iDJ_sMvXsYs?si=7EmKMZ27IPXjrECL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video5);
  main.appendChild(practicals);
  const precaution = document.createElement("section");
  const cautionHead = document.createElement("h3");
  ...
  const precautions = [
    "I ensured that I wore my lab coat and personal protective equipment (PPE)",
    "I ensured that I avoided error due to parallax where taking measurements",
    "I Ensured that the workpiece is securely clamped in a vice or using appropriate holding tools before working on it.",
  ];
  let cautionBox = [];
  for (let i = 0; i < precautions.length; i++) {
    cautionBox[i] = document.createElement("li");
  ...
  const concText = document.createElement("p");
  concText.textContent =
    "At the end of this experiment, a V- fit, a square fit and dovetail joint was created from mild steel pieces and the methods of filing and the applications of bench fitting.";
  conclusion.appendChild(concText);
  main.appendChild(conclusion);
  const references = document.createElement("section");
  const refHead = document.createElement("h3");
  ...
  const reference = [
    "Production Engineering Laboratory Manual for ELA201 and ELA202 by Department of Production Engineering, University of Benin.",
    "Benchwork and Fitting by Dr. Hamesh Babu Nanvala",
    "Bench Work And Fitting by W J Peck",
  ];
  let refBox = [];
  for (let i = 0; i < reference.length; i++) {
    refBox[i] = document.createElement("li");
...
const displayHS201 = () => {
  ...
  const objList = document.createElement("ul");
  const objectives = [
    "To know how to prepare welding edge before welding",
    "To know the different welding joints",
    "To know the different welding positions",
    "To know the various arc welding processes",
    "To know the various arc welding equipments",
    "To know the safety recommendations for arc welding processes",
    "To produce a butt joint using arc welding",
  ];
  let list = [];
  for (let i = 0; i < objectives.length; i++) {
    list[i] = document.createElement("li");
  ...
  text1.textContent =
    "In welding, there are four (4) main different types of welding positions which include:";
  ...
  const explain1 = document.createElement("div");
  explain1.textContent =
    "There are different types of welding processes but in this experiment we are dealing with arc welding process.";
  theory.appendChild(explain1);
  const explain2 = document.createElement("div");
  explain2.textContent =
    "Arc welding is the most common type of welding process, and it uses an electric current to create an arc that melts the metal. Arc welding is a metal joining process that utilizes the intense heat generated by an electric arc to melt the metals at the joint, fusing them together once they cool. Here's a breakdown of the core aspects of the process:";
  ...
  const stepList1 = document.createElement("ul");
  const steps1 = [
    "The given mild steel are thoroughly cleaned of rust and scale",
    ...
    "The electrode is fitted in the electrode holder and the welding current is set to be a proper value",
    "The ground clamp is fastened to the welding table.",
    "Wearing the apron and using the face shield, the arc is stuck and holding the two pieces together, first run of the weld is done to fill the root gap",
    "Second run of the weld is done with proper weaving and the uniform movement. During the process of welding, the electrode is kept at 150 to 250 from vertical and in the direction of welding.",
    "The scale formation on the welds is removed by using the chipping hammer.",
    "Filing is done to remove any spanner around the weld",
  ];
  let stepBox1 = [];
  for (let i = 0; i < steps1.length; i++) {
    stepBox1[i] = document.createElement("li");
  ...
  const video3 = document.createElement("div");
  video3.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/2axZupLAQ_U?si=rQGboM88VzTYHp_4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video3);
  const step = document.createElement("h2");
  ...
  const stepList = document.createElement("ul");
  const steps = [
    "The given mild steel pieces are thoroughly cleaned of rust and scale",
    ...
    "The electrode is fitted in the electrode holder and the welding current is set to be proper value",
    "The ground clamp is fastened to the welding table",
    "Wearing the apron and using the face shield, the arc is struck and the work pieces are tack-welded at both the ends and the centre of the joint",
    "The alignment of the lap joint is checked and the tack welded pieces are required",
    "The scale information of the welds is removed by using chipping hammer",
    "Filing is done to remove any spanner around the weld",
  ];
  let stepBox = [];
  for (let i = 0; i < steps.length; i++) {
  ...
  const text4 = document.createElement("p");
  text4.textContent =
    "Watch how to perform the Dovetail Joint practical is below 👇";
  practicals.appendChild(text4);
  const video4 = document.createElement("div");
  video4.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/uT9dSDwoueM?si=rmFr3C78xzlYucdc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video4);
  main.appendChild(practicals);
  const precaution = document.createElement("section");
  const cautionHead = document.createElement("h3");
  ...
  const precautions = [
    "I ensured that I wore my lab coat and personal protective equipment (PPE)",
    "I ensured that the welding machine was properly grounded to prevent electrical shock.",
    "I Ensured that the welding machine and cables are in good condition before starting.",
  ];
  let cautionBox = [];
  for (let i = 0; i < precautions.length; i++) {
    cautionBox[i] = document.createElement("li");
  ...
  const concText = document.createElement("p");
  concText.textContent =
    "At the end of this experiment, a butt joint, lap joint was created from mild steel pieces by arc welding using the necessary equipments and also using different welding positions.";
  conclusion.appendChild(concText);
  main.appendChild(conclusion);
  const references = document.createElement("section");
  const refHead = document.createElement("h3");
...
const displayMS201 = () => {
  ...
  const objList = document.createElement("ul");
  const objectives = [
    "To study the characteristics features of lathe",
    "To study types of lathe operations",
    "To produce shaft using straight turning",
  ];
  let list = [];
  for (let i = 0; i < objectives.length; i++) {
    list[i] = document.createElement("li");
  ...
  const text2 = document.createElement("p");
  text2.textContent =
    "The lathe machine is applied in different aspects in our everyday world, which include:";
  theory.appendChild(text2);
  const category = [
    {
      title: "Manufacturing",
  ...
  const text1 = document.createElement("p");
  text1.textContent =
    "Sequence of operations are performed by the lathe machine which includes:";
  theory.appendChild(text1);
  const catalog = [
    {
      title: "Facing",
  ...
  head1.textContent =
    "Watch the operations performed on the lathe machine and even more";
  theory.appendChild(head1);
  const video4 = document.createElement("div");
  video4.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/SvlZHHDXCZs?si=TCK5E9hveatatgPy" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  theory.appendChild(video4);
  const video3 = document.createElement("div");
  video3.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/km6ickQglVY?si=BPw-eCbc0RAe1VjX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  theory.appendChild(video3);
  main.appendChild(theory);
  const practicals = document.createElement("section");
  const step1 = document.createElement("h2");
  step1.textContent =
    "PRACTICAL : HOW TO PERFORM STEP TURNING AND TAPER TURNING ON LATHE MACHINE";
  practicals.appendChild(step1);
  const step3 = document.createElement("h3");
  step3.textContent = "PROCEDURE:";
  practicals.appendChild(step3);
  ...
  const steps1 = [
    ...
    "Fix the cutting tool in the tool post and centering operation is performed so that the axis of the job coincides with the lathe axis",
    "Give the feed and depth of the cut to the cutting tool",
    "Facing operation is performed from the center of the job towards outward or from the circumference towards the center",
    "Plain turning operation is performed until the diameter of the workpiece reduces to 23mm",
    "Check the dimensions by using Vernier calipers",
    "Then chamfering is done on the 23mm diameter surface",
    "Reverse the work piece in the chuck and facing operation is performed to reduce the length of work piece to the required dimensions",
    "Again plain turning operation is performed until the diameter of the work piece reduces to 18mm",
    "Using the v-cutting tool grooving operation is performed according to the given dimensions and finish the groove using parting tool",
    "Swivel the compound slide to the required angle and taper turning operation by rotating the compound slide wheel.",
  ...
  const text3 = document.createElement("p");
  text3.textContent =
    "The link to watch how to perform the taper turning operation on lathe machine practical is below 👇";
  practicals.appendChild(text3);
  const video5 = document.createElement("div");
  video5.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/dksI7FC8iZQ?si=UPv4G_C7wKhGc8Ue" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video5);
  const text4 = document.createElement("p");
  text4.textContent =
    "The link to watch how to perform the step turning operation on lathe machine practical is below 👇";
  practicals.appendChild(text4);
  const video6 = document.createElement("div");
  video6.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/3Cy1yStc93w?si=QxRQfI3O_uJ2jxJT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  const precautions = [
    "I ensured that I wore my lab coat and personal protective equipment (PPE)",
    "I ensured that I kept hands clear of moving parts ",
    "I Ensured that I used coolant or lubrication to reduce friction, dissipate heat, and improve surface finish",
  ];
  let cautionBox = [];
  for (let i = 0; i < precautions.length; i++) {
    cautionBox[i] = document.createElement("li");
  ...
  const concText = document.createElement("p");
  concText.textContent =
    "At the end of this experiment, the lathe machine was used to perform step turning and taper turning on the given workpiece and understood sequence of operations of the lathe machine.";
  conclusion.appendChild(concText);
  main.appendChild(conclusion);
  const references = document.createElement("section");
  const refHead = document.createElement("h3");
  ...
  const reference = [
    ...
    "Lathe Operation and Maintenance by John D. Lawson",
  ];
  let refBox = [];
  for (let i = 0; i < reference.length; i++) {
    refBox[i] = document.createElement("li");
...
const displayAS201 = () => {
  ...
  const objList = document.createElement("ul");
  const objectives = [
    "To know the major parts of an internal combustion engine and their functions.",
    "To know the different classifications of the internal combustion engine",
    "To be able to describe the working cycle of a four- stroke-cycle internal combustion spark ignition engine and compression ignition engine",
    "To be able to diagnose simple internal combustion engine faults",
    "To know how to change the engine oil of an internal combustion engine",
    "To be able to identify the tools used to effect repairs on an internal combustion engine",
    "To know the routine checks and routine maintenance carried out on an internal combustion engine",
  ];
  let list = [];
  for (let i = 0; i < objectives.length; i++) {
    list[i] = document.createElement("li");
  ...
  engineHead.textContent =
    "THE INTERNAL COMBUSTION ENGINE AND THE PARTS OF AN INTERNAL COMBUSTION ENGINE";
  ...
  const description = document.createElement("p");
  description.textContent =
    "The internal combustion engine consists of various parts and some of these parts are listed below: ";
  theory.appendChild(description);
  const parts = [
    {
  ...
  stroke.textContent =
    "A four-stroke cycle is commonly used by both spark-ignition (SI) and the combustion ignition (CI) engines discussed above briefly to transform fuel into useful energy. This consists of :";
  ...
  const text1 = document.createElement("p");
  text1.textContent =
    "Watch how the four cycle stroke works and how the internal combustion engine works";
  theory.appendChild(text1);
  const video1 = document.createElement("div");
  video1.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/ZQvfHyfgBtA?si=OEHS2Tg6ckvlpaGJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  internal.textContent =
    "An internal combustion engine is meant to be checked regularly and also undergo some maintenance which include:";
  ...
  const checkList = document.createElement("ul");
  const checks = [
    "Check the battery terminals for corrosion and ensure they are tight and secure and test the battery voltage and charging system to ensure proper operation.",
    "Check the oil level using the dipstick and top up if necessary. Also, monitor the oil condition and schedule regular oil changes.",
    "Check the condition of belts and hoses for cracks, wear, or loose connections. Cracked or worn belts and hoses can break and lead to engine problems",
    "Look around and check the engine compartment for any signs of leaks, including oil, coolant, or other fluids. Leaks can indicate potential problems and should be addressed promptly.",
    "Inspect and check the belts for wear, cracks, or fraying. Replace worn or damaged belts to prevent unexpected failures.",
  ];
  let array = [];
  for (let i = 0; i < checks.length; i++) {
    array[i] = document.createElement("li");
  ...
  const maintenance = [
    "Regularly change the engine oil and oil filter according to the manufacturer's recommended intervals. Fresh oil lubricates engine components, reduces wear, and helps maintain engine performance.",
    "Regularly replace the engine air filter at regular intervals to ensure proper airflow and filtration. A clean air filter helps optimize engine performance and fuel efficiency.",
    "Regularly replace the fuel filter to prevent fuel system contamination and maintain proper fuel flow.",
    "Regularly replace spark plugs at the recommended intervals to ensure reliable ignition and efficient combustion because worn or fouled spark plugs can lead to poor engine performance and reduced fuel efficiency.",
    "Regularly replace the timing belt or timing chain to prevent engine damage due to timing system failure.",
  ];
  let box = [];
  ...
  tool.textContent =
    "FEW TOOLS USED TO EFFECT REPAIRS ON AN INTERNAL COMBUSTION ENGINE:";
  ...
  step.textContent =
    "STEPS TAKEN TO CHANGE THE OIL IN AN INTERNAL COMBUSTION ENGINE";
  theory.appendChild(step);
  const stepList = document.createElement("ul");
  const steps = [
    "Get the supplies you'll need, such as engine oil (the kind and viscosity that the manufacturer recommends), a fresh oil filter, a wrench or socket set to remove the drain plug and oil filter, a drain pan to catch the used oil, and protective gloves and safety glasses.",
    "Put the car in park on a level area and apply the parking brake. Make sure the engine is cool to prevent hot oil burns. To access the underbelly, lift the car if needed using jacks or ramps.",
    "Look beneath the engine to find the oil drain plug. If you're not sure where it is exactly, check the owner's manual. To collect the spent oil, place the drain pan underneath the drain plug.",
    "Carefully remove the oil drain plug by turning it counter clockwise with a wrench or socket set. Keep in mind that the oil could be heated. After the drain stopper is loose, fully remove it and let the old oil run out into the drain pan. Make sure that all of the oil is captured by the drain pan.",
    "Locate the oil filter, typically located near the oil pan. Use an oil filter wrench to loosen the oil filter in a counter clockwise direction. Once loosened, carefully unscrew and remove the old oil filter. Be prepared for oil to spill out when removing the filter, so ensure the drain pan is positioned to catch any spills.",
    "Apply a small layer of fresh engine oil to the rubber gasket on the new oil filter before installing it. This facilitates the creation of a good seal and makes removal simpler when the next oil change is performed.",
    "Carefully screw the new oil filter onto the engine by hand in a clockwise direction until it is snug. Avoid over-tightening the filter, as this can damage the gasket or cause leaks.",
    "After the old oil has completely drained, clean the drain plug and look for any damage to the washer or gasket. If required, swap out the gasket or washer. Using a wrench or socket set, carefully reinstall the drain plug and tighten it firmly.",
    "Find and take off the oil filler cap located atop the engine. As directed by the manufacturer and contained in the owner's manual, use a funnel to add the right kind and quantity of new engine oil.",
    "After adding new oil, replace the oil filler cap securely. Start the engine and let it run for a few minutes to circulate the new oil throughout the engine. Turn off the engine and allow it to sit for a few minutes to allow the oil to settle",
    "To check the oil level, remove the oil dipstick while the engine is off, clean it, fully insert it again, and then remove it once again. If extra oil is needed to get it to the right level, add it.",
    "Properly dispose of the old oil and oil filter according to local regulations. Many auto parts stores and recycling centers accept used oil for recycling.",
  ];
  let stepBox = [];
  for (let i = 0; i < steps.length; i++) {
    stepBox[i] = document.createElement("li");
  ...
  const text2 = document.createElement("p");
  text2.textContent =
    "Watch how to change the oil of an internal combustion engine of a car";
  theory.appendChild(text2);
  const video2 = document.createElement("div");
  video2.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/O1hF25Cowv8?si=3x-n7uQOPEgDEK4q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  theory.appendChild(video2);
  main.appendChild(theory);
  const precaution = document.createElement("section");
  const cautionHead = document.createElement("h3");
  ...
  const precautions = [
    "I ensured that I wore my lab coat and personal protective equipment (PPE)",
    "I ensured that before performing any maintenance or repairs, allow the engine to cool down to prevent burns from hot engine components, exhaust gases, or fluids",
    "I Ensured that I read and understand the manufacturer's instructions and safety guidelines provided in the owner's manual or service manual before performing any maintenance or repairs.",
  ];
  let cautionBox = [];
  for (let i = 0; i < precautions.length; i++) {
    cautionBox[i] = document.createElement("li");
  ...
  const concText = document.createElement("p");
  concText.textContent =
    "At the end of this experiment, the parts of the internal combustion engine was understood and were identified and also how the internal combustion engine works and also how the four cycle strokes works.";
  conclusion.appendChild(concText);
  main.appendChild(conclusion);
  const references = document.createElement("section");
  const refHead = document.createElement("h3");
...
const displayFS201 = () => {
  ...
  const objectives = [
    ...
    "To know what moulding sands are",
    "To familiarize with the tools and materials used in foundry shop",
    "To produce a simple cast",
  ];
  let list = [];
  for (let i = 0; i < objectives.length; i++) {
    list[i] = document.createElement("li");
  ...
  const text2 = document.createElement("p");
  text2.textContent =
    "There are several different types of foundry patterns, each suited for different applications. Some common types include:";
  theory.appendChild(text2);
  const div = document.createElement("div");
  const text = document.createElement("div");
  ...
  const box = document.createElement("div");
  box.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/Uv28tqCOtAg?si=LuG3xBJHOySzcRIn" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  div.appendChild(box);
  ...
  box1.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/cFcSJMRSz1c?si=lCMAs06oYQQL90tX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  ...
  expText1.textContent =
    "Foundry sand, sometimes referred to as molding sand, is a specially prepared substance that foundry shops utilize during the casting process. It is used as a medium to make molds that are filled with molten metal to create castings. A specially formulated mixture, typically consisting of:";
  ...
  const stepList1 = document.createElement("ul");
  const steps1 = [
    "First a bottom board is placed either on the molding platform or on the floor making the surface even",
    ...
    "Freshly prepared moulding sand of requisite quality is now poured into the drag and on the pattern to a thickness of 30 to 50mm.",
    ...
    "Now with a vent wire which is of 1 to 2 mm diameter with a pointed end, vent holes are in the drag to the full depth of the flask as well as to the pattern to facilitate the removal of gases during casting solidification. This completes the preparation of the drag.",
    "Now the finished drag flask is rolled over to the bottom board exposing the pattern",
    "Using a slick, the edges of the sand around the pattern is repaired.",
    "The cope flask on the top of the drag is located aligning again with the help of the pins of the drag box.",
    "Sprue of the gating system for making the sprue passage is located at a small distance of about 50mm from the pattern. The sprue base, runners and the in-gates are also located as shown risers are also placed. Freshly prepared facing sand is poured around the pattern",
    "The moulding sand is then poured in the cope box. The sand is adequately rammed, excess sand is scraped and vent holes are made all over in the cope as in the rag",
    "The sprue and the riser are carefully withdrawn from the flask",
    "Later the pouring basin is cut near the top of the sprue.",
    ...
    "Now the cope and drag pattern halves are withdrawn by using the draw spikes and rapping the pattern all around to slightly enlarge the mould cavity so that the walls are not spoiled by the withdrawing pattern.",
    "The runners and gates are to be removed or to be cut in the mould carefully without spoiling the mould.",
    "Any excess or loose sand is applied in the runners and mould cavity is blown away using the bellows",
    "Now the facing paste is applied all over the mould cavity and the runners which would give the finished casting a good surface finish",
    "A dry sand core is prepared using a core box. After suitable baking, it is places in the mould cavity",
    "The cope is placed back on the drag taking care of the alignment of the two by means of the pins",
    "The mould is ready for pouring molten metal. The liquid metal is allowed to cool and become solid which is the casting desired.",
  ];
  let stepBox1 = [];
  for (let i = 0; i < steps1.length; i++) {
    stepBox1[i] = document.createElement("li");
  ...
  const text5 = document.createElement("p");
  text5.textContent =
    "Watch how to perform the mould using solid pattern practical is below 👇";
  practicals.appendChild(text5);
  const video5 = document.createElement("div");
  video5.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/6Y2IxLg6OZs?si=ngnIrgbfUFneLPKS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video5);
  const video6 = document.createElement("div");
  video6.innerHTML =
    '<iframe src="https://www.youtube-nocookie.com/embed/88stYwHbIzY?si=29xMhp9-JpkdITmD" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>';
  practicals.appendChild(video6);
  main.appendChild(practicals);
  const precaution = document.createElement("section");
  const cautionHead = document.createElement("h3");
  ...
  const precautions = [
    "I ensured that I wore my lab coat and personal protective equipment (PPE)",
    "I ensured that proper tool handling to avoid injuries.",
    "I Ensured that the procedures were duely followed to avoid errors",
  ];
  let cautionBox = [];
  for (let i = 0; i < precautions.length; i++) {
    cautionBox[i] = document.createElement("li");
  ...
  const concText = document.createElement("p");
  concText.textContent =
    "At the end of this experiment, a mould was created using the appropriate apparatus and also using the single/solid pattern";
  conclusion.appendChild(concText);
  main.appendChild(conclusion);
  const references = document.createElement("section");
  const refHead = document.createElement("h3");
  ...
  const reference = [
    ...
    "Foundry Technology by P R Beeley",
  ];
  let refBox = [];
  for (let i = 0; i < reference.length; i++) {
    refBox[i] = document.createElement("li");
